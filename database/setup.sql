...
CREATE TABLE teams (
    ...
    team_name VARCHAR(100) UNIQUE,        -- Full team name (NULL if only abbreviation exists).
    abbreviation VARCHAR(10) UNIQUE NOT NULL       -- Short name (e.g., "DUKE").
...
CREATE TABLE games (
    ...
    team1_id INT NOT NULL,                           -- First team in the matchup.
    team2_id INT NOT NULL,                           -- Second team in the matchup.
    game_time DATE NOT NULL,            -- When the game is scheduled.
    team1_score INT,                         -- Added column to store final score of team1. [EDITED]
    team2_score INT,                         -- Added column to store final score of team2. [EDITED]
    team1_odds DECIMAL(5,2) DEFAULT NULL,                -- Betting odds for Team 1.
    team2_odds DECIMAL(5,2) DEFAULT NULL,                -- Betting odds for Team 2.
...
CREATE TABLE bets (
    ...
    user_id INT NOT NULL,                            -- The user who placed the bet.
    game_id INT NOT NULL,                            -- The game being bet on.
    team_id INT NOT NULL,                            -- The team the user is betting on.
